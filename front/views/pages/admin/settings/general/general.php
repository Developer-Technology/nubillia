    ...
    <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
        <li class="nav-item">
            <button type="button" class="nav-link active"
                onclick="window.open('/settings/general','_self');">General</button>
        </li>
        <li class="nav-item">
            <button type="button" class="nav-link" onclick="window.open('/settings/server','_self');">Servidor De
                Correo</button>
        </li>
        <li class="nav-item">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group mt-2 mb-3">
                            <input type="text" class="form-control tags-input" pattern='[-\\(\\)\\=\\%\\&\\$\\;\\_\\*\\"\\#\\?\\¿\\!\\¡\\:\\,\\.\\0-9a-zA-ZñÑáéíóúÁÉÍÓÚ ]{1,}' onchange="validateJS(event,'regex')" value="<?php echo implode(" ,", json_decode($getSetting->keywords_setting, true)) ?>" name="kw-emp" placeholder="Palabras clave" required>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group mt-2 mb-3">
                            <textarea class="summernote" name="description-emp" required><?php echo $getSetting->description_setting ?></textarea>
                            <div class="invalid-feedback">Este campo es obligatorio</div>
                        </div>
