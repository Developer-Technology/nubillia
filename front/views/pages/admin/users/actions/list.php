...
<div class="card">
    ...
    <div class="card-header mb-0 pb-0">
        <div class="row">
            ...
            <div class="col-md-6 d-flex gap-1 align-items-center justify-content-md-end">
                ...
                <a href="/users/new" class="btn btn-primary mt-2 mb-2">
                    Nuevo Registro
                </a>
    ...
    <div class="card-datatable table-responsive pt-0">
        <table id="adminsTable" class="datatable-project border-top table-sm table table-hover adminsTable tableUsersAdmin">
